...
NODECELLAR_DOCKER_EXAMPLE_URL = 'git@github.com:cloudify-cosmo/' \
                                'cloudify-nodecellar-docker-example.git'


class DockerPluginTest(TestCase):

    def _test_docker_plugin_impl(self, blueprint_file):
        self.repo_dir = clone(NODECELLAR_DOCKER_EXAMPLE_URL, self.workdir)
...
class OpenStackDockerNodeCellarTestBase(DockerPluginTest):

    def _test_docker_openstack_nodecellar(self, blueprint_file):
        self._test_docker_nodecellar_impl(blueprint_file)
...
class OpenStackDockerNodeCellarTest(OpenStackDockerNodeCellarTestBase):

    def test_openstack_docker_nodecellar(self):
        self._test_openstack_docker_nodecellar(
            'docker-openstack-blueprint.yaml')
